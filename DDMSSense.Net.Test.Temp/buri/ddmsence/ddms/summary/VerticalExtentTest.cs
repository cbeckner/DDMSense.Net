...
//ORIGINAL LINE: private String getExpectedOutput(boolean isHTML) throws buri.ddmsence.ddms.InvalidDDMSException
		...
		public virtual void TestElementConstructorInvalid() {
			foreach (string sVersion in SupportedVersions) {
				...
				Element minElement = Util.buildDDMSElement(MinVerticalExtentName, Convert.ToString(TEST_MIN));
				...
				Element maxElement = Util.buildDDMSElement(MaxVerticalExtentName, Convert.ToString(TEST_MAX));
...
//ORIGINAL LINE: public void testHTMLTextOutput() throws buri.ddmsence.ddms.InvalidDDMSException
		...
		public virtual void TestDoubleEquality() {
			foreach (string sVersion in SupportedVersions) {
				DDMSVersion.CurrentVersion = sVersion;
				VerticalExtent component = GetInstance(SUCCESS, GetValidElement(sVersion));
				assertEquals(component.MinVerticalExtent, Convert.ToDouble(TEST_MIN));
				assertEquals(component.MaxVerticalExtent, Convert.ToDouble(TEST_MAX));
			}
		}
