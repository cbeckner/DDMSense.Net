...
namespace buri.ddmsence.ddms.summary {
	...
	using Point = buri.ddmsence.ddms.summary.gml.Point;
	using PointTest = buri.ddmsence.ddms.summary.gml.PointTest;
	using Polygon = buri.ddmsence.ddms.summary.gml.Polygon;
	using PolygonTest = buri.ddmsence.ddms.summary.gml.PolygonTest;
	using Position = buri.ddmsence.ddms.summary.gml.Position;
	using PositionTest = buri.ddmsence.ddms.summary.gml.PositionTest;
	using SRSAttributes = buri.ddmsence.ddms.summary.gml.SRSAttributes;
	using SRSAttributesTest = buri.ddmsence.ddms.summary.gml.SRSAttributesTest;
...
//ORIGINAL LINE: public BoundingGeometryTest() throws buri.ddmsence.ddms.InvalidDDMSException
