	...
	public class ExtensibleElementTest : AbstractBaseTestCase {
		...
		public virtual void TestConstructorEquality() {
			foreach (string sVersion in SupportedVersions) {
				...
				Element element = Util.buildElement(TEST_PREFIX, TEST_NAME, TEST_NAMESPACE, "This is an extensible element.");
		...
		public virtual void TestConstructorInequalityDifferentValues() {
			foreach (string sVersion in SupportedVersions) {
				DDMSVersion.CurrentVersion = sVersion;
				ExtensibleElement elementComponent = GetInstance(SUCCESS, FixtureElement);
				Element element = Util.buildElement(TEST_PREFIX, "newName", TEST_NAMESPACE, "This is an extensible element.");
				ExtensibleElement dataComponent = GetInstance(SUCCESS, element);
