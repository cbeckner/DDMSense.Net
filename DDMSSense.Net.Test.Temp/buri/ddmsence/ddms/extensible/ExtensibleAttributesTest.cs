 ...
 */
namespace buri.ddmsence.ddms.extensible {
	...
	public class ExtensibleAttributesTest : AbstractBaseTestCase {
		...
		private static readonly Attribute TEST_ATTRIBUTE = new Attribute("ddmsence:relevance", TEST_NAMESPACE, "95");
		...
		/// <returns> a valid object </returns>
		private ExtensibleAttributes GetInstance(string message, IList<Attribute> attributes) {
			bool expectFailure = !Util.isEmpty(message);
...
//ORIGINAL LINE: public void testElementConstructorValid() throws buri.ddmsence.ddms.InvalidDDMSException
		public virtual void TestElementConstructorValid() {
			foreach (string sVersion in SupportedVersions) {
				...
				// All fields
				Element element = (new Keyword("testValue", null)).XOMElementCopy;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void testIsEmpty() throws buri.ddmsence.ddms.InvalidDDMSException
