...
namespace DDMSSense.DDMS.SecurityElements.Ism {
	...
	/// in a <seealso cref="SecurityAttributes"/> or <seealso cref="NoticeAttributes"/> instance.
	/// </para>
	/// 
	/// <ul>
	...
	public class ISMVocabulary {
		...
		/// <summary>
		/// Filename for the enumerations allowed in a declassException attribute </summary>
		public const string CVE_DECLASS_EXCEPTION = "CVEnumISM25X.xml";

		/// <summary>
		/// Filename for the enumerations allowed in an atomicEnergyMarkings attribute </summary>
		public const string CVE_ATOMIC_ENERGY_MARKINGS = "CVEnumISMAtomicEnergyMarkings.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a classification attribute </summary>
		public const string CVE_ALL_CLASSIFICATIONS = "CVEnumISMClassificationAll.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a classification attribute (US only) </summary>
		public const string CVE_US_CLASSIFICATIONS = "CVEnumISMClassificationUS.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a compliesWith attribute </summary>
		public const string CVE_COMPLIES_WITH = "CVEnumISMCompliesWith.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a displayOnlyTo attribute </summary>
		public const string CVE_DISPLAY_ONLY_TO = "CVEnumISMRelTo.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a disseminationControls attribute </summary>
		public const string CVE_DISSEMINATION_CONTROLS = "CVEnumISMDissem.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a FGIsourceOpen attribute </summary>
		public const string CVE_FGI_SOURCE_OPEN = "CVEnumISMFGIOpen.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a FGIsourceProtected attribute </summary>
		public const string CVE_FGI_SOURCE_PROTECTED = "CVEnumISMFGIProtected.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a nonICmarkings attribute </summary>
		public const string CVE_NON_IC_MARKINGS = "CVEnumISMNonIC.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a nonUSControls attribute </summary>
		public const string CVE_NON_US_CONTROLS = "CVEnumISMNonUSControls.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a noticeType attribute </summary>
		public const string CVE_NOTICE_TYPE = "CVEnumISMNotice.xml";

		/// <summary>
		/// Filename for the enumerations allowed in an ownerProducer attribute </summary>
		public const string CVE_OWNER_PRODUCERS = "CVEnumISMOwnerProducer.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a pocType attribute </summary>
		public const string CVE_POC_TYPE = "CVEnumISMPocType.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a releasableTo attribute </summary>
		public const string CVE_RELEASABLE_TO = "CVEnumISMRelTo.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a SARIdentifier attribute </summary>
		public const string CVE_SAR_IDENTIFIER = "CVEnumISMSAR.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a SCIcontrols attribute </summary>
		public const string CVE_SCI_CONTROLS = "CVEnumISMSCIControls.xml";

		/// <summary>
		/// Filename for the enumerations allowed in a typeOfExemptedSource attribute </summary>
		public const string CVE_TYPE_EXEMPTED_SOURCE = "CVEnumISMSourceMarked.xml";

		private static List<string> COMMON_NETWORK_TYPES = new List<string>();
		...
		private static readonly IDictionary<string, IDictionary<string, List<string>>> LOCATION_TO_ENUM_TOKENS = new Dictionary<string, IDictionary<string, List<string>>>();
		private static readonly IDictionary<string, IDictionary<string, List<string>>> LOCATION_TO_ENUM_PATTERNS = new Dictionary<string, IDictionary<string, List<string>>>();
		...
		private static void LoadEnumeration(string enumLocation, string enumerationKey) {
			...
			foreach(var term in terms) {
				...
				bool isPattern = (bool)Convert.ToBoolean(value.Attribute(REG_EXP_NAME));
				if (value != null) {
					if (isPattern) {
		...
		/// will be based on the current value of <code>DDMSVersion.getCurrentVersion()</code>.</para>
		/// </summary>
		...
		public static List<string> GetEnumerationTokens(string enumerationKey) {
			...
			if (vocabulary == null) {
				throw new System.ArgumentException("No controlled vocabulary could be found for this key: " + enumerationKey);
			}
			return (vocabulary);
		}
		...
		protected internal static bool EnumContains(string enumerationKey, string value) {
			...
			if (!isValidToken) {
				foreach (string patternString in GetEnumerationPatterns(enumerationKey)) {
                    var regex = System.Text.RegularExpressions.Regex.Match(value, patternString);
					if (regex.Success) {
						isValidToken = true;
						break;
					}
