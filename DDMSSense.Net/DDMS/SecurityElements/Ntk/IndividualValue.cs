...
namespace DDMSSense.DDMS.SecurityElements.Ntk {
	...
	/// @since 2.0.0
	/// </summary>
	public sealed class IndividualValue : AbstractNtkString {
...
//ORIGINAL LINE: public IndividualValue(nu.xom.Element element) throws DDMSSense.DDMS.InvalidDDMSException
		public IndividualValue(Element element) : base(false, element) {
		}
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public IndividualValue(String value, String id, String idReference, String qualifier, DDMSSense.DDMS.SecurityElements.Ism.SecurityAttributes securityAttributes) throws DDMSSense.DDMS.InvalidDDMSException
		public IndividualValue(string value, string id, string idReference, string qualifier, SecurityAttributes securityAttributes) : base(false, IndividualValue.GetName(DDMSVersion.GetCurrentVersion()), value, id, idReference, qualifier, securityAttributes, true) {
		}
...
//ORIGINAL LINE: protected void validate() throws DDMSSense.DDMS.InvalidDDMSException
		protected internal override void Validate() {
			Util.RequireQualifiedName(Element, Namespace, IndividualValue.GetName(DDMSVersion));
			base.Validate();
		}
		...
		public override bool Equals(object obj) {
			if (!base.Equals(obj) || !(obj is IndividualValue)) {
				return (false);
			}
			return (true);
		}
		...
		public class Builder : AbstractNtkString.Builder {
			...
			/// </summary>
			public Builder(IndividualValue value) : base(value) {
			}

			/// <seealso cref= IBuilder#commit() </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public IndividualValue commit() throws DDMSSense.DDMS.InvalidDDMSException
			public override IndividualValue Commit() {
				return (Empty ? null : new IndividualValue(Value, ID, IDReference, Qualifier, SecurityAttributes.Commit()));
			}
		}
	}
}