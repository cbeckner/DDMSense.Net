...
//ORIGINAL LINE: public Service(nu.xom.Element element) throws DDMSSense.DDMS.InvalidDDMSException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Service(java.util.List<String> names, java.util.List<String> phones, java.util.List<String> emails) throws DDMSSense.DDMS.InvalidDDMSException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Service(java.util.List<String> names, java.util.List<String> phones, java.util.List<String> emails, DDMSSense.DDMS.Extensible.ExtensibleAttributes extensions) throws DDMSSense.DDMS.InvalidDDMSException
		public Service(List<string> names, List<string> phones, List<string> emails, ExtensibleAttributes extensions) : base(Service.GetName(DDMSVersion.GetCurrentVersion()), names, phones, emails, extensions, true) {
		}
...
//ORIGINAL LINE: protected void validate() throws DDMSSense.DDMS.InvalidDDMSException
		protected internal override void Validate() {
			Util.RequireDDMSQName(Element, Service.GetName(DDMSVersion));
			base.Validate();
		}
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Service commit() throws DDMSSense.DDMS.InvalidDDMSException
