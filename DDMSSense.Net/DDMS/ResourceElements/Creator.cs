...
namespace DDMSSense.DDMS.ResourceElements {
	...
	/// @since 2.0.0
	/// </summary>
	public class Creator : AbstractProducerRole {
...
//ORIGINAL LINE: public Creator(nu.xom.Element element) throws DDMSSense.DDMS.InvalidDDMSException
		public Creator(Element element) : base(element) {
		}
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Creator(DDMSSense.DDMS.IRoleEntity entity, java.util.List<String> pocTypes, DDMSSense.DDMS.SecurityElements.Ism.SecurityAttributes securityAttributes) throws DDMSSense.DDMS.InvalidDDMSException
		public Creator(IRoleEntity entity, List<string> pocTypes, SecurityAttributes securityAttributes) : base(Creator.GetName(DDMSVersion.GetCurrentVersion()), entity, pocTypes, securityAttributes) {
		}
...
//ORIGINAL LINE: protected void validate() throws DDMSSense.DDMS.InvalidDDMSException
		protected internal override void Validate() {
			Util.RequireDDMSQName(Element, Creator.GetName(DDMSVersion));
			base.Validate();
		}

		/// <seealso cref= Object#equals(Object) </seealso>
		public override bool Equals(object obj) {
			return (base.Equals(obj) && (obj is Creator));
		}
		...
		public class Builder : AbstractProducerRole.Builder {
			...
			/// </summary>
			public Builder(Creator producer) : base(producer) {
			}

			/// <seealso cref= IBuilder#commit() </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Creator commit() throws DDMSSense.DDMS.InvalidDDMSException
			public override Creator Commit() {
				return (Empty ? null : new Creator(CommitSelectedEntity(), PocTypes, SecurityAttributes.Commit()));
			}
		}
	}
