...
//ORIGINAL LINE: public Publisher(nu.xom.Element element) throws DDMSSense.DDMS.InvalidDDMSException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Publisher(DDMSSense.DDMS.IRoleEntity entity, java.util.List<String> pocTypes, DDMSSense.DDMS.SecurityElements.Ism.SecurityAttributes securityAttributes) throws DDMSSense.DDMS.InvalidDDMSException
		public Publisher(IRoleEntity entity, List<string> pocTypes, SecurityAttributes securityAttributes) : base(Publisher.GetName(DDMSVersion.GetCurrentVersion()), entity, pocTypes, securityAttributes) {
		}
...
//ORIGINAL LINE: protected void validate() throws DDMSSense.DDMS.InvalidDDMSException
		protected internal override void Validate() {
			Util.RequireDDMSQName(Element, Publisher.GetName(DDMSVersion));
			base.Validate();
		}
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Publisher commit() throws DDMSSense.DDMS.InvalidDDMSException
			public override Publisher Commit() {
