...
namespace DDMSense.Test.DDMS.ResourceElements
{
    ...
    public class PersonTest : AbstractBaseTestCase
    {
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_NameAndNamespace()
        {
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_ElementConstructorValid()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion version = DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_DataConstructorValid()
        {
            foreach (string sVersion in SupportedVersions)
            {
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_ElementConstructorInvalid()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion version = DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_DataConstructorInvalid()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_Warnings()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion version = DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_ConstructorEquality()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_ConstructorInequalityDifferentValues()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_HTMLTextOutput()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_BuilderEquality()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_BuilderIsEmpty()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion.SetCurrentVersion(sVersion);
        ...
        [TestMethod]
        public virtual void ResourceElements_Person_BuilderValidation()
        {
            foreach (string sVersion in SupportedVersions)
            {
                DDMSVersion.SetCurrentVersion(sVersion);
