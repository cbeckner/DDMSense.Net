...
//ORIGINAL LINE: public void testCustomPrefix() throws DDMSense.Net.Test.DDMS.InvalidDDMSException
		public virtual void TestCustomPrefix() {
			...
			XElement element = Util.buildElement("customPrefix", Language.getName(DDMSVersion.CurrentVersion), @namespace, null);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void testAttributeWarnings() throws DDMSense.Net.Test.DDMS.InvalidDDMSException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void testSameVersion() throws DDMSense.Net.Test.DDMS.InvalidDDMSException
